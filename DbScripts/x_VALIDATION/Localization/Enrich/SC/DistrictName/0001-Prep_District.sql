...
declare @etlRoot varchar(100), 
	...
	; 
select 	
	@etlRoot='C:\EnrichETLProd', -- consider setting this dynamically by inserting x_DATAVALIDATION.ParamValues using batch command 
	...
	@linkedServerAddress = '10.10.10.12x' -- in x please update 3 or 4
select
	@linkedServerAlias = @linkedServerAddress+upper(@district),
	@remoteDbUser = @district+'Conv',
	@remoteDbPwd = 'remotedbpassword', 
	@enrichDataSource='.',
	@enrichDbname = 'EnrichDatabase',
