...
INSERT servicedef(ID,Name,StateCode,MinutesPerUnit ,UserDefined,UseServiceAmountRange,PhysicianReferralRequired, NotTiedToIep,ProgramID, ScheduleFreqOnly )
SELECT tsd.ID,tsd.Name,tsd.StateCode,tsd.MinutesPerUnit ,tsd.UserDefined
,0 as UseServiceAmountRange,0 as PhysicianReferralRequired, 0 as NotTiedToIep, 'F98A8EF2-98E2-4CAC-95AF-D7D89EF7F80C' as ProgramID, 0 as ScheduleFreqOnly
FROM @servdef tsd 
